...
import { get_lab_agg_url, get_emergency_agg_url, get_resources_agg_url, update_default_values, get_default_values, get_visit_url, get_discharge_type_url, homedata_url, get_dept_url, signup_url, opt_url, login_url, resend_opt_url, update_user_url, update_usertheme_url, validuser_url, labdata_url, resources_url, emergency_url, disease_url, get_test_type_url, request_pass_url, verify_request_url, changepass_url, newPassword_url, proceduredata_url, get_procedure_type_url, get_procedure_agg_url, get_person_list_url, drugdata_url, get_drug_type_url, get_drug_agg_url } from "./API";
...
// getting data for  procedures
const getdata_procedure = async (date_from, date_to, department_names, grouping_type, token, type) => {
    const url = `${proceduredata_url}?date_from=${date_from}&date_to=${date_to}&department_names=${department_names}&grouping_type=${grouping_type}&type=${type}`;
...
const getproceduretypes_test = async (token) => {
    const url = `${get_procedure_type_url}`;
    try {
        const headers = {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
...
const getprocedureData = async (date_from, date_to, departments, testTypes, factor, groupingType, token) => {
    const url = `${get_procedure_agg_url}/?date_from=${date_from}&date_to=${date_to}&department_names=${departments}&type=${testTypes}&factor=${factor === 'department' ? 'DepartmentName' : 'Lab Record Name'}&grouping_type=${groupingType}`;
...
// getting data for  drug
const getdata_drug= async (date_from, date_to, department_names, grouping_type, token, type) => {
    const url = `${drugdata_url}?date_from=${date_from}&date_to=${date_to}&department_names=${department_names}&grouping_type=${grouping_type}&type=${type}`;
...
const getdrugtypes_test = async (token) => {
    const url = `${get_drug_type_url}`;
    try {
        const headers = {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
...
const getdrugData = async (date_from, date_to, departments, testTypes, factor, groupingType, token) => {
    const url = `${get_drug_agg_url}/?date_from=${date_from}&date_to=${date_to}&department_names=${departments}&type=${testTypes}&factor=${factor === 'department' ? 'DepartmentName' : 'Lab Record Name'}&grouping_type=${groupingType}`;
...
export { getdrugData, getdrugtypes_test, getdata_drug, getperson_list, getprocedureData, getproceduretypes_test, getdata_procedure, getDischargeData, getLabData, getBloodGroupData, updateDefaultValues, getDefaultValues, getMultiData, getDischargeType, changePassword, requestVerify, requestResetPassword, gettypes_test, getdata_disease, getdata_emergency, getdata_resources, getdata_home, getDeptList, registerUser, verifyotp, resendOtp, loginUser, updateUser, updateUserTheme, validUser, getdata_lab, changeNewPassword }
