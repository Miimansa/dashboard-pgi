...
const Graphfilter_disease = () => {
    ...
    const handleUpdate = async () => {
        setloading(true)
        const formattedData = convertObject(selectedTypes, 'disease');
    ...
    const user = useSelector((state) => (state.user.user.bio.disease));
    return (
        <>
            {dataConfig.disease.map((item, index) => (
                <div>
...
export default Graphfilter_disease;