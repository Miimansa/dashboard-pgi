...
const Graphfilter_resources = () => {
    ...
    const handleUpdate = async () => {
        setloading(true)
        const formattedData = convertObject(selectedTypes, 'resources');
    ...
    const user = useSelector((state) => (state.user.user.bio.resources));
    return (
        <>
            {dataConfig.resources.map((item, index) => (
                <div>
...
export default Graphfilter_resources;